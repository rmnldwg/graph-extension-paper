...
\begin{enumerate}
    ...
    \item train the probabilistic model based on a multi-centric dataset consisting of \variable{output/num_patients.txt} patients from %\variable{output/num_institutions.txt} institutions.
