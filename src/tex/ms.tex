...
%These evidences are shown, among others, in \cref{table:evidence}. 
...
%which is in great detail compared to the base graph in the results (\cref{sec:results}). All considered graphs' performances are visualized in \cref{fig:ranking}.
