...
\begin{center}
    \begin{tabular}{|l|l|l|l|}
        ...
        \hline
        base graph    & \variable{output/bg_BIC.txt} & \variable{output/bg_max_llh.txt} & \variable{output/bg_mean_llh.txt} \\
        winning graph & \variable{output/wg_BIC.txt} & \variable{output/wg_max_llh.txt} & \variable{output/wg_mean_llh.txt} \\
        \hline
    \end{tabular}
\end{center}
