...
{\it Level VII:} The two models' predictions w.r.t. the prevalence of involvement patterns that include \gls{lnl} VII are not compared in a dedicated figure, as this level is only connected to the primary tumor in both graphs.
