...
\begin{figure}
    ...
    \begin{centering}
        ...
        \caption{Predictions for the prevalence of \gls{lnl} VII involvement based on the base graph (hatched) and the winning graph (blue histogram) plotted agains the beta posterior over the prevalence in the data (solid line).}
        \label{fig:VII_prevs}
    \end{centering}
\end{figure}
