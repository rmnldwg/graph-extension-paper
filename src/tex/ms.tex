...
To determine the optimal graph describing the data at hand best, we considered six models, each with one of the green candidate arcs of \cref{fig:extended_graph} added to the base graph. Every one of these models was evaluated as described below in \cref{subsec:complete_model:comparison}.
