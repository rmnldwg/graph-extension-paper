...
We have more freedom in choosing how to connect the \glspl{lnl} to each other.
...
\begin{figure}
    \centering
    \includegraphics{figures/extended_graph.png}
