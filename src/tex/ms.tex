...
\begin{deluxetable}{|cccccc|rr|rr|}
    ...
    \tablehead{
        ...
        I & II & III & IV & V & VII & \multicolumn{2}{c}{\textbf{early} } & \multicolumn{2}{c|}{\textbf{late} } \\
    }
    \startdata
    \variable{output/data_table.tex}
    \enddata
...
\begin{figure*}
    ...
    \begin{centering}
        ...
        \caption{Prevalence of involvement as predicted by the base graph model for different scenarios involving the most commonly metastatic \glspl{lnl} II, III and IV (shaded histograms). The model's predictions are compared to Beta posteriors over the prevalence based on the frequency of the same scenarios and a uniform prior (slid lines). The top panel shows some selected scenarios with early T-category tumors and the bottom panel with late T-category. \label{fig:bg_prevalences}}
    \end{centering}
\end{figure*}
