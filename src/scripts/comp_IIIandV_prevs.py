...
that involve the LNLs III and V. Compare these prevalence predictions for the
...
if __name__ == "__main__":
    ...
    draw(axes[0], contents=panels["early"], xlims=(0., 8.), hist_kwargs={"nbins": 40})
    axes[0].set_ylim(bottom=0., top=0.9)
    axes[0].set_ylabel("early T-cat.", fontweight="bold")
    axes[0].set_yticks([])
    axes[0].legend()

    draw(axes[1], contents=panels["late"], xlims=(0., 8.), hist_kwargs={"nbins": 40})
