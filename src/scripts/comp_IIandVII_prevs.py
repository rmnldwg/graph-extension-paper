...
that involve the LNLs II and VII. Compare these prevalence predictions for the
...
BASE_GRAPH_INPUT = paths.data / "bg_IIandVII_prevs.hdf5"
WIN_GRAPH_INPUT = paths.data / "wg_IIandVII_prevs.hdf5"
    ...
    for stage in ["early", "late"]:
        panels[stage] = [
            Histogram.from_hdf5(
                ...
                dataname=f"IIandVII/{stage}",
                label="LNL II with VII",
                color=USZ["red"],
            ),
            Histogram.from_hdf5(
            ...
            Histogram.from_hdf5(
                filename=WIN_GRAPH_INPUT,
                dataname=f"VIInotII/{stage}",
                label="LNL VII without II",
                color=USZ["blue"],
            ),
            Histogram.from_hdf5(
                filename=BASE_GRAPH_INPUT,
